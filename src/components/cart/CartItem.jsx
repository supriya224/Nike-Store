...
const CartItems = ({
  item: { id, color, title, shadow, text, img, price, cartQuantity },
}) => {
  ...
  const onIncreasedItemQTY=()=>{
    dispatch(setIncreaseItemQTY({ id, color, title, shadow, text, img, price, cartQuantity }))
  }
  const onDecreasedItemQTY=()=>{
    dispatch(setDecreaseItemQTY({ id, color, title, shadow, text, img, price, cartQuantity }))
  }
  return (
    <>
